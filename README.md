...
**Stable Diffusion v1.5**: [HuggingFace Link](https://www.google.com/search?q=https://huggingface.co/runwayml/stable-diffusion-v1-5)
...
```bash
accelerate launch ./attack_feature_three/AFTS.py \
    --cuda \
    --low_vram_mode \
